...
//            $user_password=crypt($user_password,$salt);
            ...
            die("query failed".mysqli_error($connect));
              ...
              echo "<h5 class='bg-success'>You've registered successfully!  go <a href='index.php'>Home Page</a></h5>";
        }
    }else{
...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="radio-button">
        ...
        <label for="user_role"><input type="radio" value="admin" name="radio" disabled>Admin</label>
    </div>
